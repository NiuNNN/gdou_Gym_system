<template>
  <div class="descriptions-box">
    <el-page-header @back="goBack" content="添加管理员" title="返回主页">
    </el-page-header>
      ...
      <div class="forget-box">
        ...
        >
          ...
          <el-form-item style="margin-left: 120px">
            <el-button type="primary" @click="put()">确认</el-button>
      ...
      <el-dialog
        ...
        width="30%">
          ...
          <div slot="footer" class="dialog-footer">
            ...
            <el-button type="primary" @click="check('userForm')"
              >确定</el-button
            >
          </div>
      </el-dialog>
...
export default {
  data() {
    ...
    return {
      ...
      rules: {
        ...
        name: [{ validator: validateipt, trigger: 'blur', required: true }],
  ...
  methods: {
    ...
    check(formName) {
      ...
      request({
        url: '/superusers/getuserpwd/' + usercode,
        method: 'Get',
      }).then((res) => {
